    ...
    <div class="row">
        <div class="col-md-12">
            <div id="accordion" class="checkout">
                <form method="POST" action="{{ route('hypopharynx') }}">
                    @csrf

                                 <!--zero-->

                    <div class="panel checkout-step">
                        <h3 style="text-align: center; margin-bottom: 20px; padding-bottom: 10px; border-bottom: 2px solid;">Hypopharynx</h3>
                        <div>
