    ...
    <div class="row">
        <div class="col-md-12">
            <div id="accordion" class="checkout">
                <form action="{{ route('caviteOrale') }}" method="POST">
                    @csrf

                    <!--zero-->

                    <div class="panel checkout-step">
                        <h3 style="text-align: center; margin-bottom: 20px; padding-bottom: 10px; border-bottom: 2px solid;">Cavite Orale</h3>
                        <div>
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 ">
                                                    ...
                                                    <option value="{{ $localisation->titreLocalisation }}">{{ $localisation->titreLocalisation }}</option>
                                                    @endforeach
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <div class="checkout-step-body">
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <h5 style="margin-top:20px;">pTNM</h5>
                                        <div class="form-group">
                                            <label>T :</label>
                                        ...
                                        <div class="checkout-login col-md-12">
                                            ...
                                            <div class="form-group" style="margin-top:10px;">
                                                ...
                                                <label style="margin-top:10px;" class="container chekingfacteur">Echec du 1er Traitement
                                                    <input type="checkbox" name="RELIQUAT[]" value="NON_REPONSE">
                                                    <span class="checkmark"></span>
                                                </label>
