    ...
    <div class="row">
        <div class="col-md-12">
            <div id="accordion" class="checkout">
                <form action="{{ route('larynx') }}" method="POST">
                    @csrf
                    ...
                    <div class="panel checkout-step">
                        <h3 style="text-align: center; margin-bottom: 20px; padding-bottom: 10px; border-bottom: 2px solid;">Larynx</h3>
                        <div>
                    ...
                    <div class="panel checkout-step">
                        ...
                        <div role="tab" id="headingTwo"> <span class="checkout-step-number">2</span>
                            ...
                            <h4 class="checkout-step-title"> <a class="collapsed" role="button" data-toggle="collapse"
                                    data-parent="#accordion" href="#collapseTwo">Type Histologique</a>
                            </h4>
                        </div>
                            ...
                            <div class="checkout-step-body">
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            <h5 class="col-md-12 control-label" for="time">Facteurs Mauvais Pronostic
                                                :</h5>
                                                <div class="col-md-12">
